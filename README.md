...
- ✅ Upload de artefatos (resultados dos testes)

## 📋 Pré-requisitos

- Node.js 18+
- Apache JMeter 5.4.1- Conta no New Relic (para integração)
...
### Dashboard do New Relic

Abaixo está um exemplo visual do dashboard gerado no New Relic a partir dos dados enviados pela POC. Este dashboard mostra as métricas de performance coletadas durante os testes:

![Dashboard do New Relic](images/newrelic-dashboard.png)
...
**Sintoma**: ErroArquivo result.jtl não foi gerado!"
**Possíveis causas**:
- API mock não está respondendo
- Problemas de conectividade
- Configuração incorreta do JMeter

#### 3. Falha no upload para New Relic
...
├── images/
│   └── newrelic-dashboard.png   # Exemplo visual do dashboard do New Relic
├── package.json
└── README.md
```
